...
def file_replace(fname, pat, s_after, nombre, directorio):
    ...
    # se define el path donde se va aguardar los archivos modificados (respetando su path)
        ...
        completeName = os.path.join(save_path + directorio[2:], nombre)
    ...
    for dirpath, dirnames, filenames in os.walk(dir_name):
        ...
        for fname in filenames:
            ...
            if try_to_replace(fname, replace_extensions):
                ...
                file_replace(fullname, pat, s_after,fname, dirpath)
